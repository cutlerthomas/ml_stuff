...
class DataFrameSelector(sklearn.base.BaseEstimator, sklearn.base.TransformerMixin):
    ...
    def __init__(self, do_predictors=True, do_numerical=True):
        ...
        self.mCategoricalPredictors = ["Sex", "ChestPainType", "FastingBS", "RestingECG", "ExerciseAngina", "ST_Slope"]
        self.mNumericalPredictors = ["Age", "RestingBP", "Cholesterol", "MaxHR", "Oldpeak"]
        self.mLabels = ["HeartDisease"]
        #
        # Not currently using:
        #  "Pclass"
        #  "Name"
...
def do_neural_network_fit(my_args):
    ...
    model.fit(X, y, epochs=5000, verbose=1, validation_split=0.1, callbacks=[early_stopping, tensorboard_logging])
