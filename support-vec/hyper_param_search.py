...
class DataFrameSelector(sklearn.base.BaseEstimator, sklearn.base.TransformerMixin):
    ...
    def __init__(self, do_predictors=True, do_numerical=True):
        ...
        self.mCategoricalPredictors = ["sex", "anaemia", "diabetes", "high_blood_pressure", "smoking"]
        self.mNumericalPredictors = ["age", "creatinine_phosphokinase", "ejection_fraction", "platelets", "serum_creatinine", "serum_sodium", "time"]
