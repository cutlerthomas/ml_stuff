...
class DataFrameSelector(sklearn.base.BaseEstimator, sklearn.base.TransformerMixin):
    ...
    def __init__(self, do_predictors=True, do_numerical=True):
        self.mCategoricalPredictors = ["cat0", "cat1", "cat2", "cat3", "cat4", "cat5", "cat6", "cat7", "cat8", "cat9", "cat10", "cat11",
                                       "cat12", "cat13", "cat14", "cat15", "cat16", "cat17", "cat18"]
        self.mNumericalPredictors = ["cont0", "cont1", "cont2", "cont3", "cont4", "cont5", "cont6", "cont7", "cont8", "cont9", "cont10"]
        self.mLabels = ["target"]
...
def get_data(filename):
    ...
    data = pd.read_csv(filename, dtype={"cat0": str, "cat1": str, "cat2": str, "cat3": str, "cat4": str, "cat5": str, "cat6": str
                                        , "cat7": str, "cat8": str, "cat9": str, "cat10": str, "cat11": str, "cat12": str, "cat13": str
                                        , "cat14": str, "cat15": str, "cat16": str, "cat17": str, "cat18": str})
    return data
...
def show_model(my_args):
    ...
    fig = plt.figure(figsize=(6, 6)) # size of figure in inches
